...
<body>
    ...
    <section class="hero d-flex justify-content-start ps-md-5 px-2">
      <div class="content text-white d-flex flex-column justify-content-center align-items-center align-items-md-start text-center text-md-start">
        ...
        <div class="input-group fw-semibold w-100 mx-auto d-flex justify-content-center justify-content-md-start" style="position: relative; z-index: 1;">
          <input class="border-0 px-3 w-75" style="border-radius: 5px 0 0 5px;" placeholder='Try "I need a nailtech"' type="text" name="search" id="search">
        ...
        <div class="tag-group d-flex mt-4 align-items-center justify-content-center">
          ...
          <div class="d-flex flex-wrap text-center align-items-center fw-semibold">
            <a href="people.php" class="border border-1 rounded-5 px-2 py-1 mx-1 mt-1 text-decoration-none text-white">Website Design</a>
            <a href="people.php" class="border border-1 rounded-5 px-2 py-1 mx-1 mt-1 text-decoration-none text-white">Wordpress</a>
            <a href="people.php" class="border border-1 rounded-5 px-2 py-1 mx-1 mt-1 text-decoration-none text-white">Logo Design</a>
            <a href="people.php" class="border border-1 rounded-5 px-2 py-1 mx-1 mt-1 text-decoration-none text-white">Video Editing</a>
          </div>
        </div>
      </div>
    </section>
  ...
  <main>
    ...
    <section class="popular-services py-5 px-5">
      <h2 class="mb-4">We can help you...</h2>
    ...
    <!-- <section class="fvr-guides py-5 px-3 px-sm-4 px-md-5">
      <div class="guides-wrapper">
        <div class="guides-head-wrapper mt-2 mb-4 d-flex justify-content-between align-items-center w-100">
          <h1 style="font-size: 2.1rem;" class="my-2">BizMatch Hub guides</h1>
        ...
        <div class="guides-posts d-flex flex-wrap justify-content-xl-between" style="gap: 10px;">
          <div class="guide-post" style="width: 390px; max-width: 100%; cursor: pointer;">
            ...
            <h6 class="mt-3 mb-0 fw-semibold" style="font-size: 1.1rem;">Start an online business and work from home
            </h6>
          ...
          <div class="guide-post" style="width: 390px; max-width: 100%; cursor: pointer;">
            ...
            <p class="text-muted" style="font-size: 1.05rem;">A practical guide to understand what is digital marketing
            </p>
          </div>
          <div class="guide-post" style="width: 390px; max-width: 100%; cursor: pointer;">
            ...
            <p class="text-muted" style="font-size: 1.05rem;">A step-by-step guide to create a memorable business logo
            </p>
          </div>
        </div>
      </div>
        ...
        <div class="qlts-content col-md-5 col-12">
          ...
          <ul class="d-flex flex-column">
            <li>
              ...
              <p class="text-muted" style="font-size: 1.2rem;">Find high-quality services at every price point. No
                hourly
                rates, just
                project-based
                pricing.</p>
            ...
            <li>
              ...
              <p class="text-muted" style="font-size: 1.2rem;">Find the right freelancer to begin working on your
                project
                within minutes.</p>
            </li>
            <li>
            ...
            <li>
              ...
              <p class="text-muted" style="font-size: 1.2rem;">Questions? Our round-the-clock support team is available
                to
